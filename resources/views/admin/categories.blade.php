...
<a class="btn btn-primary categories_btn" href="{{ route('admin.category.new') }}" role="button" type="button">
...
<table class="table table-hover sortable-theme-ligh table_data" data-sortable>
  ...
  @foreach ($categories as $index => $category)
            ...
            <td>
            <form action="{{ route('admin.category.delete', ['id' => $category->catg_id]) }}" method="POST">
            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group mr-2" role="group" aria-label="First group">
                    <a class="btn btn-primary" href="{{ route('admin.category.edit', ['id' => $category->catg_id]) }}" role="button" type="button">
