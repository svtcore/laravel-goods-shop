    ...
    <table class="table">
        ...
        <tbody id="content-data">
            ...
            <tr>
                ...
                <td>
                    <form class="form-group w-100" action="{{ route('admin.orders.update', ['id' => $order->order_id ]) }}" method="POST">
                        @method('PUT')
                        @csrf
                    ...
                    <form class="form-group w-100">
                        <a class="btn btn-primary w-100" href="{{ route('admin.orders.edit', ['id' => $order->order_id ]) }}" target="_blank" role="button">{{ __('admin_order_show.edit') }}</a>
                    </form>
                </td>
            </tr>
            @else
