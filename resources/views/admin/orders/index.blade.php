...
<div class="container">
    ...
    <table class="table table-hover sortable-theme-ligh" data-sortable>
        <thead>
            <tr>
                <th scope="col" class="small-column text-center">{{ __('admin_orders.order_num_tb')}}</th>
                <th scope="col" class="w_7 text-center">{{ __('admin_orders.order_date_tb')}}</th>
                <th scope="col" class="w_15 text-center">{{ __('admin_orders.order_address_tb')}}</th>
                <th scope="col" class="small-column text-center">{{ __('admin_orders.order_price_tb')}}</th>
                <th scope="col" class="small-column text-center">{{ __('admin_orders.order_payment_tb')}}</th>
                <th scope="col" class="small-column text-center">{{ __('admin_orders.order_status_tb')}}</th>
                <th scope="col" data-sortable="false" class="small-column">{{ __('admin_orders.order_action_tb')}}</th>
            </tr>
        </thead>
        <tbody id="content-data">
            ...
            <tr class="text-center">
                ...
                @if ($order->payment_types->deleted_at != null)
