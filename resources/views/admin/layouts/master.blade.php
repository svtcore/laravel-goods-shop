      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light rounded" id="mob_menu_expander">
        ...
        <div class="navbar-collapse collapse" id="navbarsExample09">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.orders') }}">{{ __('admin_master.orders') }}</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.users') }}">{{ __('admin_master.users') }}</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.managers') }}">{{ __('admin_master.managers') }}</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.products') }}">{{ __('admin_master.products') }}</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.categories') }}">{{ __('admin_master.categories') }}</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('admin.payments') }}">{{ __('admin_master.payment') }}</a>
            </li>
            @endauth
          </ul>
          @auth('admin')
