...
<br />
<a class="btn btn-primary w_30 add_btn" href="{{ route('admin.payment.new') }}" role="button" type="button">
...
<table class="table table-hover sortable-theme-ligh data_small_table" data-sortable>
  ...
  @foreach ($payments as $index => $payment)
            ...
            <td>
            <form action="{{ route('admin.payment.delete', ['id' => $payment->pay_t_id]) }}" method="POST">
            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group mr-2" role="group" aria-label="First group">
                    <a class="btn btn-primary" href="{{ route('admin.payment.edit', ['id' => $payment->pay_t_id]) }}" role="button" type="button">
