    ...
    <div class="flex_blocks">
        ...
        <div class="popular_prod">
            <div class="list-group">
                ...
                <a href="{{ route('user.products.show', ['id' => $oproduct->products->product_id]) }}" target="_blank" class="list-group-item w-100 list-group-item-action">
                    <b>№ {{ $index + 1 }} </b>
                    @if (app()->getLocale() == "en")
