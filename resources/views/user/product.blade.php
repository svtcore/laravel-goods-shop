...
<div class="product-path">
    <span><a href="{{ route('user.main.page') }}">Main</a> -> <a href="{{ route('user.category.show', ['id' => $product_info->categories->catg_id]) }}">
                    @if (app()->getLocale() == "en") 
...
<div class="product-info-block">
    ...
    <div class="product-details-block">
        ...
        <div class="prod_del_edit">
            <form action="{{ route('admin.product.delete', ['id' => $product_info->product_id]) }}" method="POST">
                    <a class="btn btn-outline-primary w_45 float-left" href="{{ route('admin.product.edit', ['id' => $product_info->product_id]) }}" role="button" type="button">
