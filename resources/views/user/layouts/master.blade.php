    ...
    <nav class="first_nav">
      <div class="first_nav_block">
        ...
        <div class="float-right">
          <a href="{{ route('user.orders.cart') }}" class="ml-2" id="cart_icon">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light rounded" id="mob_menu_expander">
      ...
      <div class="navbar-collapse collapse" id="navbarsExample09">
        <ul class="navbar-nav nav_center">
          ...
          @if(app()->getLocale() == "en")
          <li class="nav-item">
            <a class="nav-link" href="{{ route('user.categories.show', ['id' => $categ->catg_id]) }}">{{ $categ->catg_name_en }}</a>
          </li>
          @elseif(app()->getLocale() == "de")
          <li class="nav-item">
            <a class="nav-link" href="{{ route('user.categories.show', ['id' => $categ->catg_id]) }}">{{ $categ->catg_name_de }}</a>
          </li>
          @elseif(app()->getLocale() == "uk")
          <li class="nav-item">
            <a class="nav-link" href="{{ route('user.categories.show', ['id' => $categ->catg_id]) }}">{{ $categ->catg_name_uk }}</a>
          </li>
          @elseif(app()->getLocale() == "ru")
          <li class="nav-item">
            <a class="nav-link" href="{{ route('user.categories.show', ['id' => $categ->catg_id]) }}">{{ $categ->catg_name_ru }}</a>
          </li>
          @endif
          @endforeach
